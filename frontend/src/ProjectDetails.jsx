...
export default function ProjectDetails() {
  ...
  useEffect(() => {
    if (projectId) {
      axios.get(`https://employee-management-bend.vercel.app/getProject/id/${projectId}`, { withCredentials: true })
        .then(response => {
  ...
  const handleSave = () => {
    axios.put(`https://employee-management-bend.vercel.app/editProject/id/${projectId}`, editedProject, { withCredentials: true })
      .then(() => {
  ...
  const handleStatusClose = (status) => {
    if (status) {
      axios.put(`https://employee-management-bend.vercel.app/editProject/id/${projectId}`, { ...editedProject, status }, { withCredentials: true })
        .then(() => {
