...
export default function EmployeeDetails() {
  ...
  useEffect(() => {
    if (employeeId) {
      axios.get(`employee-management-be-six.vercel.app/getEmployee/id/${employeeId}`, { withCredentials: true })
        .then(response => {
          ...
          if (Array.isArray(projectIds) && projectIds.length > 0) {
            ...
            Promise.all(
              projectIds.map(id =>
                axios.get(`employee-management-be-six.vercel.app/getProject/id/${id}`, { withCredentials: true })
  ...
  const handleSave = () => {
    axios.put(`employee-management-be-six.vercel.app/editEmployee/editbyid/${employeeId}`, editedEmployee, { withCredentials: true })
      .then(() => {
  ...
  const handleStatusClose = (status) => {
    if (status) {
      axios.put(`employee-management-be-six.vercel.app/editEmployee/editbyid/${employeeId}`, { ...editedEmployee, status }, { withCredentials: true })
        .then(() => {
