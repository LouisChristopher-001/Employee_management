...
export default function Login() {
  ...
  const requestOtp = async () => {
    ...
    setLoading(true);
    try {
      await axios.post('employee-management-be-six.vercel.app/request-otp', { email }, { withCredentials: true });
      setOtpSent(true);
  ...
  const handleLogin = async () => {
    setLoading(true);
    try {
      const response = await axios.post('employee-management-be-six.vercel.app/login', { email, otp }, { withCredentials: true });
