...
export default function Home() {
  ...
  useEffect(() => {
    ...
    // Fetch projects
    axios.get('https://employee-management-be-six.vercel.app/projects/',{ withCredentials: true })
  ...
  const handleLogout = () => {
    ...
    axios.post('https://employee-management-be-six.vercel.app/logout', {}, { withCredentials: true })
      .then(response => {
